    ...
    <div className="max-w-4xl mx-auto text-center">
      <div className="mb-12 animate-bounce-in">
        ...
        <div className="space-y-2 mb-8">
          ...
          <p className="text-xl text-orange-500 font-semibold animate-scale-in delay-500">
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-4 mb-8 animate-scale-in delay-1600">
        ...
        <button 
          ...
          className="flex items-center justify-center space-x-3 px-8 py-4 border border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 animate-ultra-smooth hover:scale-105 hover:shadow-2xl hover:-translate-y-2 group"
        >
